...
hist(totalstepsperday$stepstotal,main = "Total Steps Per Day", xlab = "Number of Steps Taken Per Day", ylim = c(0,40), xaxt = "n")
axis(1, at=seq(2500,25000,by = 5000), labels = c("0-5000","5001-10,000","10,001-15,000","15,001-20,000","20,001-25,000"))
```
...
The mean of the total number of steps taken per day: `r stepsmean`
The median of the total number of steps taken per day: `r stepsmedian`
...
The 5-minute interval with the maximum number of steps: `r intmax`
...
Total number of rows with NA: `r numNA`
...
hist(imputedstepsbyday$stepstotal,main = "Total Steps Per Day", xlab = "Number of Steps Taken Per Day", ylim = c(0,40), xaxt = "n")
axis(1, at=seq(2500,25000,by = 5000), labels = c("0-5000","5001-10,000","10,001-15,000","15,001-20,000","20,001-25,000"))
```
...
The mean of the total number of steps taken per day: `r impstepsmean`
The median of the total number of steps taken per day: `r impstepsmedian`

These results are different than those reported earlier. The original recorded mean and median were `r stepsmean` and `r stepsmedian` respectively. The imputed data mean is higher than the original mean (`r stepsmedian`) and the imputed median is higher than the original (`r impstepsmedian`).
